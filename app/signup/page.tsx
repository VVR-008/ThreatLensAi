        ...
        <Card className="w-full max-w-md bg-black/40 backdrop-blur-xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-gray-300">
              Create your account to start protecting your digital assets
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  <label htmlFor="firstName" className="text-sm font-medium text-cyan-400">
                    First Name
                  </label>
                ...
                <div className="space-y-2">
                  <label htmlFor="lastName" className="text-sm font-medium text-cyan-400">
                    Last Name
                  </label>
                  <Input
                    id="lastName"
                    ...
                    className="bg-black/50 border-gray-600 focus:border-cyan-500 focus:ring-cyan-500/50 text-white placeholder-gray-400"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label htmlFor="company" className="text-sm font-medium text-cyan-400">
                  Company (Optional)
                </label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <label htmlFor="confirmPassword" className="text-sm font-medium text-cyan-400">
                  Confirm Password
                </label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
              ...
              <div className="flex items-start space-x-2">
                <input
                  ...
                  className="mt-1 rounded border-gray-600 bg-black/50 text-cyan-500 focus:ring-cyan-500/50"
                />
